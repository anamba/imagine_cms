...
Imagine 3 is licensed under AGPLv3, meaning that if you run a modified version on a publicly-accessible server, you need to (1) make it clear that you've modified it and (2) offer source code (Github makes that a snap).
